    ...
    <section className="section-padding bg-card/30">
      <div className="container mx-auto text-center">
        <AnimatedSection>
          ...
          <Link to="/contact" className="inline-block px-10 py-4 rounded-xl bg-primary text-primary-foreground font-semibold hover:opacity-90 transition-opacity glow-primary text-lg">
            Get in Touch
          </Link>
        </AnimatedSection>
      </div>
